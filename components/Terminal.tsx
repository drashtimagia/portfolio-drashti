...
const commands: Record<string, () => string[]> = {
  ...
  about: () => [
    "Hi, I'm Drashti!",
    'An AI Engineer who loves building intelligent,',
    'useful applications. This portfolio is styled like VS Code',
  ...
  contact: () => [
    'Contact Information:',
    '  Email:    drashtimagia02@gmail.com',
    '  GitHub:   github.com/drashtimagia',
    '  LinkedIn: linkedin.com/in/drashti-magia-a185201b3',
  ],
  themes: () => [
    'Available themes:',
